            ...
            <Pressable onPress={handleLogin} disabled={loading} className="active:opacity-80">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Ionicons name="clipboard" size={20} color="#ffffff" style={{ marginRight: 8 }} />
                    <Text style={{ color: '#ffffff', fontSize: 16, fontWeight: '700', letterSpacing: 0.3 }}>
                      Auditor Sign In
                    </Text>
                  </>
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 12, color: '#7e22ce', lineHeight: 18 }}>
                  This login is for authorized auditors to review and monitor hand hygiene compliance data.
                </Text>
              </View>
            </View>
          </View>
